...
#import "PayssionAppDelegate.h"
#import "PayssionViewController.h"

@interface PayssionAppDelegate ()

@end

@implementation PayssionAppDelegate


- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    
    PayssionViewController *paymentViewController = [[PayssionViewController alloc] init];
